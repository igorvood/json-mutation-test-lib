...
internal class DeleteTest {
    ...
    companion object {
        ...
        private val testData = listOf(
            ...
            TestCase("Удаление целого объекта", delete { "a2/a3" }, Ok("""{"a2":{"a3":null},"z1":15,"list":["P","O"]}""")),
            TestCase("Удаление целого массива", delete { "a2/a3/a4" }, Ok("""{"a2":{"a3":{"a4":null}},"z1":15,"list":["P","O"]}""")),
            TestCase(
                "Удаление элемента массива",
                delete { "a2/a3/a4[0]" },
                Ok("""{"a2":{"a3":{"a4":[{"f1":"f11","f2":"f22"}]}},"z1":15,"list":["P","O"]}""")
            ),
            TestCase(
                "Удаление иного элемента массива",
                delete { "a2/a3/a4[1]" },
                Ok("""{"a2":{"a3":{"a4":[{"f1":"f1","f2":"f2"}]}},"z1":15,"list":["P","O"]}""")
            ),
            TestCase(
            ...
            TestCase(
                ...
                Ok("""{"a2":{"a3":{"a4":[{"f1":"f1","f2":"f2"},{"f1":null,"f2":"f22"}]}},"z1":15,"list":["P","O"]}""")
            ),
            TestCase(
