    ...
    withData(
        listOf(
            TestCaseOnAll(
                ...
                expectedMutate = Ok("""{"a2":1.0,"z1":15}"""),
                expectedDelete = Ok("""{"a2":null,"z1":15}"""),
            ),
            TestCaseOnAll(
                ...
                expectedMutate = Ok("""{"a2":{"a3":{"a4":[{"f1":"f11","f2":"f22"},1.0]}},"z1":15}"""),
                expectedDelete = Ok("""{"a2":{"a3":{"a4":[{"f1":"f11","f2":"f22"}]}},"z1":15}"""),
            ),
            TestCaseOnAll(
                description = "значения простого поля для не существующего сложного json объекта в массиве",
                jsonPath = JsonPath("""a2/a3/a4[2]"""),
                expectedAdd = Ok("""{"a2":{"a3":{"a4":[{"f1":"f1","f2":"f2"},{"f1":"f11","f2":"f22"},1.0]}},"z1":15}"""),
            ...
            TestCaseOnAll(
                ...
                expectedMutate = Ok("""{"a2":{"a3":{"a4":[{"f1":"f1","f2":"f2"},{"f1":"f11","f2":"f22"}]}},"z1":1.0}"""),
                expectedDelete = Ok("""{"a2":{"a3":{"a4":[{"f1":"f1","f2":"f2"},{"f1":"f11","f2":"f22"}]}},"z1":null}"""),
            ),
            TestCaseOnAll(
                description = "значения простого поля для не существующего простого поля json объекта",
                jsonPath = JsonPath("""z99"""),
                expectedAdd = Ok("""{"a2":{"a3":{"a4":[{"f1":"f1","f2":"f2"},{"f1":"f11","f2":"f22"}]}},"z1":15,"z99":1.0}"""),
